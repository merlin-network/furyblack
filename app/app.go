...
import (
	...
	_ "github.com/merlin-network/fury/v6/client/docs/statik"

	"github.com/merlin-network/fury/v6/app/ante"
	"github.com/merlin-network/fury/v6/x/epochs"
	epochskeeper "github.com/merlin-network/fury/v6/x/epochs/keeper"
	epochstypes "github.com/merlin-network/fury/v6/x/epochs/types"
	"github.com/merlin-network/fury/v6/x/erc20"
	erc20client "github.com/merlin-network/fury/v6/x/erc20/client"
	erc20keeper "github.com/merlin-network/fury/v6/x/erc20/keeper"
	erc20types "github.com/merlin-network/fury/v6/x/erc20/types"
	"github.com/merlin-network/fury/v6/x/fees"
	feeskeeper "github.com/merlin-network/fury/v6/x/fees/keeper"
	feestypes "github.com/merlin-network/fury/v6/x/fees/types"

	"github.com/merlin-network/fury/v6/x/inflation"
	inflationkeeper "github.com/merlin-network/fury/v6/x/inflation/keeper"
	inflationtypes "github.com/merlin-network/fury/v6/x/inflation/types"
	"github.com/merlin-network/fury/v6/x/recovery"
	recoverykeeper "github.com/merlin-network/fury/v6/x/recovery/keeper"
	recoverytypes "github.com/merlin-network/fury/v6/x/recovery/types"
	"github.com/merlin-network/fury/v6/x/vesting"
	vestingkeeper "github.com/merlin-network/fury/v6/x/vesting/keeper"
	vestingtypes "github.com/merlin-network/fury/v6/x/vesting/types"

	//govshuttle imports
	"github.com/merlin-network/fury/v6/x/govshuttle"
	govshuttleclient "github.com/merlin-network/fury/v6/x/govshuttle/client"
	govshuttlekeeper "github.com/merlin-network/fury/v6/x/govshuttle/keeper"
	govshuttletypes "github.com/merlin-network/fury/v6/x/govshuttle/types"

	"github.com/merlin-network/fury/v6/x/csr"
	csrkeeper "github.com/merlin-network/fury/v6/x/csr/keeper"
	csrtypes "github.com/merlin-network/fury/v6/x/csr/types"

	v2 "github.com/merlin-network/fury/v6/app/upgrades/v2"
	v3 "github.com/merlin-network/fury/v6/app/upgrades/v3"
	v4 "github.com/merlin-network/fury/v6/app/upgrades/v4"
	v5 "github.com/merlin-network/fury/v6/app/upgrades/v5"
)
...
func init() {
	...
	// manually update the power reduction by replacing micro (u) -> atto (a) Fury
...
var (
	_ servertypes.Application = (*Fury)(nil)
	_ simapp.App              = (*Fury)(nil)
	_ ibctesting.TestingApp   = (*Fury)(nil)
)

// Fury implements an extended ABCI application. It is an application
...
// NewFury returns a reference to a new initialized Ethermint application.
func NewFury(
	logger log.Logger,
	db dbm.DB,
...
func (app *Fury) Name() string { return app.BaseApp.Name() }
...
func (app *Fury) BeginBlocker(ctx sdk.Context, req abci.RequestBeginBlock) abci.ResponseBeginBlock {
	return app.mm.BeginBlock(ctx, req)
}

// EndBlocker updates every end block
func (app *Fury) EndBlocker(ctx sdk.Context, req abci.RequestEndBlock) abci.ResponseEndBlock {
	return app.mm.EndBlock(ctx, req)
}

// We are intentionally decomposing the DeliverTx method so as to calculate the transactions per second.
func (app *Fury) DeliverTx(req abci.RequestDeliverTx) (res abci.ResponseDeliverTx) {
	defer func() {
...
func (app *Fury) InitChainer(ctx sdk.Context, req abci.RequestInitChain) abci.ResponseInitChain {
...
func (app *Fury) LoadHeight(height int64) error {
	return app.LoadVersion(height)
}

// ModuleAccountAddrs returns all the app's module account addresses.
func (app *Fury) ModuleAccountAddrs() map[string]bool {
...
func (app *Fury) BlockedAddrs() map[string]bool {
...
// LegacyAmino returns Fury's amino codec.
//
// NOTE: This is solely to be used for testing purposes as it may be desirable
// for modules to register their own custom testing types.
func (app *Fury) LegacyAmino() *codec.LegacyAmino {
	return app.cdc
}
...
// NOTE: This is solely to be used for testing purposes as it may be desirable
// for modules to register their own custom testing types.
func (app *Fury) AppCodec() codec.Codec {
	return app.appCodec
}

// InterfaceRegistry returns Fury's InterfaceRegistry
func (app *Fury) InterfaceRegistry() types.InterfaceRegistry {
...
func (app *Fury) GetKey(storeKey string) *sdk.KVStoreKey {
...
//
// NOTE: This is solely to be used for testing purposes.
func (app *Fury) GetTKey(storeKey string) *sdk.TransientStoreKey {
...
func (app *Fury) GetMemKey(storeKey string) *sdk.MemoryStoreKey {
...
//
// NOTE: This is solely to be used for testing purposes.
func (app *Fury) GetSubspace(moduleName string) paramstypes.Subspace {
	subspace, _ := app.ParamsKeeper.GetSubspace(moduleName)
	return subspace
}

// SimulationManager implements the SimulationApp interface
func (app *Fury) SimulationManager() *module.SimulationManager {
	return app.sm
}

// RegisterAPIRoutes registers all application module routes with the provided
// API server.
func (app *Fury) RegisterAPIRoutes(apiSvr *api.Server, apiConfig config.APIConfig) {
...
func (app *Fury) RegisterTxService(clientCtx client.Context) {
	authtx.RegisterTxService(app.BaseApp.GRPCQueryRouter(), clientCtx, app.BaseApp.Simulate, app.interfaceRegistry)
}

func (app *Fury) RegisterTendermintService(clientCtx client.Context) {
...
func (app *Fury) GetBaseApp() *baseapp.BaseApp {
	return app.BaseApp
}

// GetStakingKeeper implements the TestingApp interface.
func (app *Fury) GetStakingKeeper() stakingkeeper.Keeper {
	return app.StakingKeeper
}

// GetIBCKeeper implements the TestingApp interface.
func (app *Fury) GetIBCKeeper() *ibckeeper.Keeper {
	return app.IBCKeeper
}

// GetScopedIBCKeeper implements the TestingApp interface.
func (app *Fury) GetScopedIBCKeeper() capabilitykeeper.ScopedKeeper {
	return app.ScopedIBCKeeper
}

// GetTxConfig implements the TestingApp interface.
func (app *Fury) GetTxConfig() client.TxConfig {
...
func (app *Fury) setupUpgradeHandlers() {
	// v2 upgrade handler
