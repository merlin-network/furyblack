...
Fury is written in Go.  We prefer to use the latest version of go because this will prevent mixed runtimes, and thus, errors. 
...
```bash
git clone https://github.com/merlin-network/fury
cd Fury
go install ./...
code .
```
...
* Each major version of fury should change the module path in go.mod.  
