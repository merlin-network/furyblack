...
fury gentx $KEY 100000000000000000000000afury --keyring-backend $KEYRING --chain-id $CHAINID --ip 34.75.78.143
...
mv $HOME/.fury/config/gentx $HOME/fury-fury/Mainnet/gentx-orion
mv $HOME/.fury/config/genesis.json $HOME/fury-fury/Mainnet/genesis-orion.json
