...
fury gentx $KEY 100000000000000000000000afury --keyring-backend $KEYRING --chain-id $CHAINID --ip 35.200.104.35
...
mv $HOME/.fury/config/gentx $HOME/fury-fury/Mainnet/gentx-atreus
mv $HOME/.fury/config/genesis.json $HOME/fury-fury/Mainnet/genesis-atreus.json
