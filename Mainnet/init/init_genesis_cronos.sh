...
fury gentx $KEY 100000000000000000000000afury --keyring-backend $KEYRING --chain-id $CHAINID --ip 34.165.151.138
...
mv $HOME/.fury/config/gentx $HOME/fury-fury/Mainnet/gentx-cronos
mv $HOME/.fury/config/genesis.json $HOME/fury-fury/Mainnet/genesis-cronos.json
