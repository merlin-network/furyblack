...
fury gentx $KEY 100000000000000000000000afury --keyring-backend $KEYRING --chain-id $CHAINID --ip 34.93.171.55
...
mv $HOME/.fury/config/gentx $HOME/fury-fury/Mainnet/gentx-samael
mv $HOME/.fury/config/genesis.json $HOME/fury-fury/Mainnet/genesis-samael.json
