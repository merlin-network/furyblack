...
fury gentx $KEY 100000000000000000000000afury --keyring-backend $KEYRING --chain-id $CHAINID --ip 34.90.61.99
...
mv $HOME/.fury/config/gentx $HOME/fury-fury/Mainnet/gentx-ares
mv $HOME/.fury/config/genesis.json $HOME/fury-fury/Mainnet/genesis-ares.json
