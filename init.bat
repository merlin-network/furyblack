...
fury add-genesis-account %KEY% 100000000000000000000000000afury --keyring-backend %KEYRING%
...
fury start --pruning=nothing %TRACE% --log_level %LOGLEVEL% --minimum-gas-prices=0.0001afury