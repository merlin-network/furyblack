...
// source: fury/erc20/v1/erc20.proto
...
type TokenPair struct {
	...
	ContractOwner Owner `protobuf:"varint,4,opt,name=contract_owner,json=contractOwner,proto3,enum=fury.erc20.v1.Owner" json:"contract_owner,omitempty"`
}
...
func init() {
	proto.RegisterEnum("fury.erc20.v1.Owner", Owner_name, Owner_value)
	proto.RegisterType((*TokenPair)(nil), "fury.erc20.v1.TokenPair")
	proto.RegisterType((*RegisterCoinProposal)(nil), "fury.erc20.v1.RegisterCoinProposal")
	proto.RegisterType((*RegisterERC20Proposal)(nil), "fury.erc20.v1.RegisterERC20Proposal")
	proto.RegisterType((*ToggleTokenConversionProposal)(nil), "fury.erc20.v1.ToggleTokenConversionProposal")
}

func init() { proto.RegisterFile("fury/erc20/v1/erc20.proto", fileDescriptor_5c364669f6882b8b) }
