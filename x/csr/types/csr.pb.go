...
func init() {
	proto.RegisterType((*CSR)(nil), "fury.csr.v1.CSR")
}

func init() { proto.RegisterFile("fury/csr/v1/csr.proto", fileDescriptor_57c53cea3d443afa) }
