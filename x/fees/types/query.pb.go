...
func init() {
	proto.RegisterType((*QueryFeesRequest)(nil), "fury.fees.v1.QueryFeesRequest")
	proto.RegisterType((*QueryFeesResponse)(nil), "fury.fees.v1.QueryFeesResponse")
	proto.RegisterType((*QueryFeeRequest)(nil), "fury.fees.v1.QueryFeeRequest")
	proto.RegisterType((*QueryFeeResponse)(nil), "fury.fees.v1.QueryFeeResponse")
	proto.RegisterType((*QueryParamsRequest)(nil), "fury.fees.v1.QueryParamsRequest")
	proto.RegisterType((*QueryParamsResponse)(nil), "fury.fees.v1.QueryParamsResponse")
	proto.RegisterType((*QueryDeployerFeesRequest)(nil), "fury.fees.v1.QueryDeployerFeesRequest")
	proto.RegisterType((*QueryDeployerFeesResponse)(nil), "fury.fees.v1.QueryDeployerFeesResponse")
}

func init() { proto.RegisterFile("fury/fees/v1/query.proto", fileDescriptor_dcaf4023fa7c026c) }
...
func (c *queryClient) Fees(ctx context.Context, in *QueryFeesRequest, opts ...grpc.CallOption) (*QueryFeesResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/fury.fees.v1.Query/Fees", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) Fee(ctx context.Context, in *QueryFeeRequest, opts ...grpc.CallOption) (*QueryFeeResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/fury.fees.v1.Query/Fee", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) Params(ctx context.Context, in *QueryParamsRequest, opts ...grpc.CallOption) (*QueryParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/fury.fees.v1.Query/Params", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) DeployerFees(ctx context.Context, in *QueryDeployerFeesRequest, opts ...grpc.CallOption) (*QueryDeployerFeesResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/fury.fees.v1.Query/DeployerFees", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_Fees_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/fury.fees.v1.Query/Fees",
	}
...
func _Query_Fee_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/fury.fees.v1.Query/Fee",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_Params_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/fury.fees.v1.Query/Params",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_DeployerFees_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/fury.fees.v1.Query/DeployerFees",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "fury.fees.v1.Query",
	...
	Metadata: "fury/fees/v1/query.proto",
}
