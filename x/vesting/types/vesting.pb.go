...
// source: fury/vesting/v1/vesting.proto
...
func init() {
	proto.RegisterType((*ClawbackVestingAccount)(nil), "fury.vesting.v1.ClawbackVestingAccount")
}

func init() { proto.RegisterFile("fury/vesting/v1/vesting.proto", fileDescriptor_c580f9d3d2a7f889) }
