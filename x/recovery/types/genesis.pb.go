...
// source: fury/recovery/v1/genesis.proto
...
func init() {
	proto.RegisterType((*GenesisState)(nil), "fury.recovery.v1.GenesisState")
	proto.RegisterType((*Params)(nil), "fury.recovery.v1.Params")
}

func init() { proto.RegisterFile("fury/recovery/v1/genesis.proto", fileDescriptor_5b0a30f85f43314c) }
