...
import (
	...
	ibctesting "github.com/merlin-network/fury/v6/ibc/testing"
...
type IBCTestingSuite struct {
	...
	pathOsmosisfury  *ibcgotesting.Path
	pathCosmosfury   *ibcgotesting.Path
...
func (suite *IBCTestingSuite) SetupTest() {
	...
	suite.furyChain.App.(*app.Fury).RecoveryKeeper.SetParams(suite.furyChain.GetContext(), params)
	...
	suite.coordinator.Setup(suite.pathOsmosisfury) // clientID, connectionID, channelID filled
	suite.coordinator.Setup(suite.pathCosmosfury)
