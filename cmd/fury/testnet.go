...
import (
	...
	cmdcfg "github.com/merlin-network/fury/v6/cmd/config"
	furykr "github.com/merlin-network/fury/v6/crypto/keyring"
	"github.com/merlin-network/fury/v6/testutil/network"
)
...
Example:
	fury testnet init-files --v 4 --output-dir ./.testnets --starting-ip-address 192.168.10.2
	`,
...
Example:
	fury testnet --v 4 --output-dir ./.testnets
	`,
		RunE: func(cmd *cobra.Command, _ []string) error {
			args := startArgs{}
			args.outputDir, _ = cmd.Flags().GetString(flagOutputDir)
...
func initTestnetFiles(
	...
	if args.chainID == "" {
		args.chainID = fmt.Sprintf("highbury_%d-1", tmrand.Int63n(9999999999999)+1)
	}
	...
	for i := 0; i < args.numValidators; i++ {
		...
		kb, err := keyring.New(sdk.KeyringServiceName(), args.keyringBackend, nodeDir, inBuf, furykr.Option())
		if err != nil {
			return err
		}
